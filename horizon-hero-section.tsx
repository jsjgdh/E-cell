...
export const Component = () => {
  ...
  const handleEmailSubmit = async (e) => {
    ...
    try {
      ...
      setEmail('');
      setEmailStatus("Thanks — you’re in.");
    } catch (_) {
    ...
    <div ref={containerRef} className="hero-container cosmos-style">
      ...
      <div className="hero-content cosmos-content">
        ...
        <div ref={subtitleRef} className="hero-subtitle cosmos-subtitle">
          <p className="subtitle-line">What’s been building quietly is almost ready.</p>
        </div>
      </div>
      ...
      <div ref={scrollProgressRef} className="scroll-progress" style={{ visibility: 'hidden' }}>
        ...
        <div className="section-counter">
          {String(currentSection + 1).padStart(2, '0')} / {String(3).padStart(2, '0')}
        </div>
      </div>
       ...
       {[...Array(2)].map((_, i) => {
          ...
          return (
            <section key={i} className="content-section">
              ...
              {i === 1 && (
                <form className="email-cta" onSubmit={handleEmailSubmit}>
                  <input
                    type="email"
